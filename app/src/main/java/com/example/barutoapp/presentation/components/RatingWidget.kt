package com.example.barutoapp.presentation.components
...
import com.example.barutoapp.ui.theme.EXTRA_SMALL_PADDING
import com.example.barutoapp.ui.theme.LightGray
import com.example.barutoapp.ui.theme.starColor
...
fun calculateStars(rating: Double): Map<String, Int> {
    ...
    var emptyFilledStars by remember {
        mutableStateOf(0)
    }
    ...
    emptyFilledStars = maxStars - (filledStars + halfFilledStars)
    return mapOf(
        "filledStars" to filledStars,
        "halfFilledStars" to halfFilledStars,
        "EmptyFilledStars" to emptyFilledStars
    )
